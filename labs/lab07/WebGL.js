...
function draw(){
    ...
    mdlMatrix.translate(-1.0, 0.82, -0.5);
    ...
    mdlMatrix.setIdentity();
    mdlMatrix.translate(0 + moveDistance, 0.2, 0);
    ...
    //robot
    mdlMatrix.setIdentity();
    mdlMatrix.translate(1.0, 0.5, 0);
    pushMatrix(mdlMatrix);
    ...
    pushMatrix(mdlMatrix);
    mdlMatrix.scale(0.2, 0.2, 0.2);
    drawOneObject(cube, mdlMatrix, 0.0, 0.4, 0.4);
}
