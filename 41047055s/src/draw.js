...
function init_mdl(){
    ...
    mdlMatrix.translate(0, 0, -12);
    mdlMatrix.scale(5,5,1);
    ...
    birdShadow.setIdentity();
    birdShadow.translate(0, -0.5 + birdY + birdYoffset,0);
    birdShadow.scale(0.5,0.5,0.5);
...
function drawAllShadows(){
    ...
    birdFromLight = drawOneObjectOnShadowfbo(cube, birdShadow);
}
...
function drawRobot( vpMatrix ) {
    ...
    // drawObjectWithTexture(cube, birdShadow, vpMatrix, birdFromLight, cur_cameraX, cur_cameraY, cur_cameraZ, "pipeTex");
...
function drawBird( vpMatrix, birdMatrix, cur_cameraX, cur_cameraY, cur_cameraZ) {
    ...
    for( var i = 0; i <= 5 ; i++){
        ...
        drawObjectWithTexture(cube, birdMatrix, vpMatrix, birdFromLight, cur_cameraX, cur_cameraY, cur_cameraZ, "gndTex");
    }
